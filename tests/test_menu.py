...
class MenuTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client.post(
            'api/v2/auth/signup', data=json.dumps(self.data["admin"]), content_type='application/json')
    ...
    def test_invalid_content_type(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["menu"]), headers=self.auth_header, content_type='text/plain')
    ...
    def test_only_admin_can_add_meal(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["menu"]), headers=self.auth_header_2, content_type='application/json')
    ...
    def test_price_cannot_be_a_string(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["string"]), headers=self.auth_header, content_type='application/json')
        self.assertEqual(res.status_code, 400)
    ...
    def test_cannot_add_meal_with_empty_spaces(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["spaces"]), headers=self.auth_header, content_type='application/json')
        self.assertEqual(res.status_code, 400)
    ...
    def test_admin_can_edit_menu(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["menu"]), headers=self.auth_header, content_type='application/json')
        res = self.client.put('/api/v2/admin/menu/1', data=json.dumps(
            self.data["update"]), headers=self.auth_header, content_type='application/json')
        self.assertEqual(res.status_code, 201)
    ...
    def test_cannot_edit_unavailable_meal(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["menu"]), headers=self.auth_header, content_type='application/json')
        res = self.client.put('/api/v2/admin/menu/3', data=json.dumps(
            self.data["update"]), headers=self.auth_header, content_type='application/json')
    ...
    def test_admin_can_delete_meal_option(self):
        ...
        res = self.client.delete(
            '/api/v2/admin/menu/1', headers=self.auth_header, content_type='application/json')
    ...
    def test_cannot_delete_unavailable_meal(self):
        ...
        res = self.client.post('/api/v2/admin/menu', data=json.dumps(
            self.data["menu"]), headers=self.auth_header, content_type='application/json')
        res = self.client.delete(
            '/api/v2/admin/menu/5', headers=self.auth_header, content_type='application/json')
